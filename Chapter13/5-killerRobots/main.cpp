...
int main ()
{
    ...
    ifstream inFile; inFile.open("robot_game_level_1.txt");
    ofstream outFile ("robot_saved_game_1.txt");

                    // 4. Verify the files opened without error
    if (!inFile)
    {
        cout << "Can't open robot_game_level_1.txt!\n"; return 1;       
                    //  1 is a conventional return value for error
    }
    if (! outFile)
    {
        cout << "Can't create file robot_saved_game_1.txt!"; return 1;
    }
    ...
    cout << "Just saved robot_saved_game_1.txt.\n"; 
