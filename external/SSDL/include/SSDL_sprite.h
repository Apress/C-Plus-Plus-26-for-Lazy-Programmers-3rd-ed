...
{
public:
	SSDL_Sprite() { setImage(nullptr); } //5-19-2016
...
private:
	...
	//width and height are its width and height, on the screen
	int x_, y_, width_, height_;

	//offset is how far the reference point is, down and right, from top left corner of the image; default is 0,0
    ...
    // but we are not doing this at this point
