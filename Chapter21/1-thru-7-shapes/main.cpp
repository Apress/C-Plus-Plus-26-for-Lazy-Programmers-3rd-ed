...
int main (int argc, char** argv)
{
   ...
   olympicSymbol.push_back(new Circle(Point2D(150,  50), RADIUS));
   olympicSymbol.push_back(new Circle(Point2D(250,  50), RADIUS));
   olympicSymbol.push_back(new Circle(Point2D(100, 100), RADIUS));
   olympicSymbol.push_back(new Circle(Point2D(200, 100), RADIUS));

   // plus a label
   olympicSymbol.push_back(new Text(Point2D(50,150),
